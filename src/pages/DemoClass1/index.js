...
function DemoClass1() {
    ...
    function getDatas() {
        axios.get(`${process.env.REACT_APP_API_URL}/batch?student_id=${userdata.id}`)
          .then(response => {
    ...
    <AdminLayout>
        <div className="container-fluid custom-div justify-content-align-items-center">
            <div className='content-justify-center align-items-'>
                <span> <h1 className='text-white mt-3'> সকল অনলাইন ব্যাচ</h1> </span>
            </div>
                ...
                <div className="col-md-6 d-flex justify-content-center">
                    <div className="box borderRedius-3">
                        <div className="box-content">
                            <h5 >{d.batch_name}</h5>
                            <p><i className="bi bi-star-fill icon"></i>{d.number_of_subject}</p>
                            <p>প্রতিদিন {d.daily_live}টি লাইভ ক্লাস</p>
                            <p>প্রতি সপ্তাহে {d.weekly_exam}টি এক্সাম</p>
